<html>
   <head>
      <title>Add Washer roducts </title>
   </head>
   
   <body>
       <h1><div style="text-align:center">Add Washer Products </div>
...
<?php // AC.php
  ...
  if (isset($_POST['select']) && isset($_POST['productId'])&& isset($_POST['cost'])) {
  ...
  $query  = "SELECT * FROM Products WHERE type='Washer'";
  $result = $conn->query($query);
 ...
 <pre>
  ...
  <form action="washer.php" method="post"><pre>
